...
> {
  ...
  public constructor(props: Record<string, never>) {
    ...
    this.state = {
      ...
      // implicit geojson
      geojsonConfig: require("/static/geo/map.json"),
    };
  ...
  public componentDidMount(): void {
    ...
    document
      .getElementById(C_ID_input_geojson)
      .setAttribute("disabled", "disabled");
    ...
    const geoPathSubmitted = function (this: HTMLInputElement) {
      console.log(this.files);
      pathSubmitted(this.files[0], geo);
    };
    document
      .getElementById(C_ID_input_geojson)
      .addEventListener("change", geoPathSubmitted, false);

    // process choropleth polygons
    const choroplethPathSubmitted = function (this: HTMLInputElement) {
      console.log(this.files);
      const reader = new FileReader();
      const onLoadAction = function (e) {
        try {
          console.log(e);
          //console.log(reader.result);
          this.polygons = JSON.parse(reader.result as string);
        } catch (ex) {
          console.log("unable to read file");
          // TODO: notify user
        }
          ...
          <div className="center f-column">
            <div>
              ...
              <select id={C_ID_select_data}>
                ...
                <option value="covidSlovakRegions.json">
                  covidSlovakRegions.json
                </option>
                <option value="floor-plan-data.json">
