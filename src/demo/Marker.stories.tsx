            ...
            <div className="demo-container">
                <div className="demo-toolbar">
                    ...
                    <select id={C_ID_select_data}>
                        <option value="gdp_oecd_years.json">gdp_oecd_years.json</option>
        ...
        return (
            <div className="demo-container">
                <div className="demo-toolbar">
                    <span>Data file: </span>
                    <select id={C_ID_select_data}>
                        <option value="energy_un.json">energy_un.json</option>
                        <option disabled></option>
                    </select>
...
export default {
    title: 'Marker and Time Series',
    component: Demo,
} as Meta;

export const GDPYearsLong: Story = () => <Demo />;
